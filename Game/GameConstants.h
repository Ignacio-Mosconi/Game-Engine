...
// 3D Model Paths
constexpr const char* ASSAULT_RIFLE_PATH = "Assets/Models/AK-47 Assault Rifle.fbx";
...
constexpr const char* ASSAULT_RIFLE_TEXTURES = "Assets/Textures/AK-47 Assault Rifle";
// Sprite Paths
